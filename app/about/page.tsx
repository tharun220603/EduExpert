  ...
  return (
    <div style={{ overflowX: "hidden" }}>
      ...
      >
        ...
        <div className="container page-hero-textured-content">
          ...
          >
            ...
            >
              EduExpert is South India's premier higher education discovery
              platform, dedicated to bridging the gap between ambitious students
        ...
        <div className="container">
          ...
          >
            <div ref={missionRef}>
              ...
              >
                EduExpert was founded with a single mission: to demystify the
                complex college admission process for high school graduates.
              </p>
              <p
                style={{
                  color: "var(--text-mid)",
              ...
              >
                We believe that every student deserves access to transparent,
                accurate, and comprehensive information about colleges, exams,
                and courses, completely free of overwhelming advertisements and
                biased promotions.
              </p>
            </div>
      ...
      <section
        ...
        style={{ background: "var(--bg-section)", padding: "80px 0" }}
      >
